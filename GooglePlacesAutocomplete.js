        ...
        if (request.status === 200) {
          ...
          if (responseJSON.status === 'OK') {
            if (this._isMounted === true) {
              ...
              if (!details.name || !details.formatted_address || !details.international_phone_number)
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.state.text !== '' && this.props.renderTip()}
        {this.state.dataSource.length > 0 ? this._getFlatList() : this.state.text.length > this.props.minLength && this.props.renderNoResults()}
        {this.state.error && this.props.renderError()}
        {this.props.children}
      </View>
    );
  }
