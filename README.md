...
| showListView             | boolean   | control if the list (results) view will be shown or not                                                                                                                                                                            | false                                                           |                                     |
...
| `setAddressTextAndDebounce`     | `(value: string) => void` | set the value of TextInput and fetch the results                                      |
